...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">XIE FOOD DELIVERY</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="Mumbai" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Mumbai</h3>
        <p>Maharashtrians consider their food to be more austere than others.</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/coffee_cup_saucer_grains_foam_73571_1920x1080.jpg" alt="Chennai" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Chennai</h3>
        <p>Street food of Chennai</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg" alt="Kolkata" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Kolkata</h3>
        <p>Bengalis share an irrevocable relationship with food!</p>
      </div>   
    </div>
  </div>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Roti (also known as chapati) is a round flatbread native to the Indian subcontinent made from stoneground wholemeal flour, traditionally known as atta, and water that is combined into a dough. Roti is consumed in many countries worldwide. Its defining characteristic is that it is unleavened. Naan from the Indian subcontinent, by contrast, is a yeast-leavened bread, as is kulcha. Like breads around the world, roti is a staple accompaniment to other foods.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">A dosa is a rice pancake, originating from South India, made from a fermented batter. It is somewhat similar to a crepe in appearance. Its main ingredients are rice and black gram, ground together in a fine, smooth batter with a dash of salt. Dosas are a typical part of diets throughout South India street foodie official, but the dish is now popular all over the Indian subcontinent. Traditionally, dosas are served hot along with sambar and chutney. They can be consumed with idli podi as well. </p>
	        </div>
	  </div>
